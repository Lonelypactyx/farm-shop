const productsData = [
  ...
  },
  {
    ...
    structure: [
      {
        property: "Энергетическая ценность",
        value: "41 ккал. / 172 кДж.",
      },
      {
        property: "Пищевая ценность",
        value: "белки - 1 г., жиры - 0,5 г., углеводы - 7,6 г. на 100 г.",
      },
    ],
  },
  {
  ...
  {
    id: 5,
    name: "Мёд майский горный.",
    description:
      "Мёд урожая 2025 года. Необычно нежный майский мёд, собранный в субтропических рощах Северо-кавказского заповедника, раскрывается целой гаммой цитрусовых оттенков.",
    price: 590,
    weight: 200,
